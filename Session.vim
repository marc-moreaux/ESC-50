...
silent only
silent tabonly
cd ~/work/ESC-50/python
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +162 utils.py
badd +9 ~/work/bc_learning_sound/dataset.py
badd +139 bc_utils.py
argglobal
silent! argdel *
$argadd utils.py
edit utils.py
...
exe 'vert 2resize ' . ((&columns * 40 + 75) / 151)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 163 - ((20 * winheight(0) + 20) / 40)
